...
class PaginationTest(TestCase):
    ...
    def test_make_pagination_range_make_sure_middle_ranges_are_correct(self):  # noqa: E501
        ...
        # Current Page = 17 | Qty Page = 2 | Middle Page = 17
        pagination = make_pagination_range(
            page_range=list(range(1, 21)),
            qty_pages=4,
            current_page=17
    ...
    def test_make_pagination_range_is_static_when_last_page_is_next(self):
        # Current Page = 18 | Qty Page = 2 | Middle Page = 18
        pagination = make_pagination_range(
            page_range=list(range(1, 21)),
            qty_pages=4,
            current_page=18
        ...
        # Current Page = 19 | Qty Page = 2 | Middle Page = 18
        pagination = make_pagination_range(
            page_range=list(range(1, 21)),
            qty_pages=4,
            current_page=19
        ...
        # Current Page = 20 | Qty Page = 2 | Middle Page = 18
        pagination = make_pagination_range(
            page_range=list(range(1, 21)),
            qty_pages=4,
            current_page=20
        ...
        # Current Page = 21 | Qty Page = 2 | Middle Page = 18
        pagination = make_pagination_range(
            page_range=list(range(1, 21)),
            qty_pages=4,
            current_page=21
